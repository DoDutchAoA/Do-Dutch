...
class TestDB(unittest.TestCase):
    ...
    #     username = "Jason"
    #     userpwd = "12345"
    #     check = q.checkRecordExistByConditions("Users", "user_name = '%s' AND "
    ...
    #
    #     check = q.checkRecordExistByConditions("Users", "user_name = '%s' AND user_pwd = '%s'",
    #     (username, userpwd2))
    ...
    #     f.signUp(username, userpwd)
    #
    #     result_list = q.selectInfoByConditions("Users", "user_id", "user_name = '%s' AND user_pwd = '%s'",
    #     (username, userpwd))
    ...
    #     u_id = f.login(username, userpwd)
    #
    #     self.assertEqual(u_id, -1)  #invalid u_id indicating no such user exist
    #
    ...
    #
    #     check = q.checkRecordExistByConditions("gGroups", "group_name = '%s'",
    #     groupName)
    #     self.assertTrue(check) #No such group exsit
    #
    #     g_id = f.createEmptyGroup(groupName, ownerId)  #insert again
    #     result_list = q.selectAllByConditions("gGroups",
    ...
    #     g_id = f.createEmptyGroup(groupName, ownerId)  #create a new group
    #
    #     check = q.checkRecordExistByConditions("gGroups",
    #     "group_name = '%s' AND owner_id = '%s'", (groupName, ownerId))
    #     self.assertTrue(check)  #The group exsits now
    #
    #     check = q.checkRecordExistByConditions("GroupUsers",
    ...
    #     result_list = q.selectInfoByConditions("GroupUsers", "member_id",
    ...
    #         memberIds.remove(removedIds[i]) #remove the removed Ids from member list
    #     self.assertEqual(set(membersDB), set(memberIds))
    #
    ...
    #
    #     self.assertEqual(q.getNumOfRecordByConditions("gGroups"), 0)    #0 group exists
    #     self.assertEqual(q.getNumOfRecordByConditions("GroupUsers",
    #     "group_id = '%s'", groupId), 0) #No members in groupId group
    #
    ...
    #     orderName = "Order0"
    #     numOfItems = 5
    #     self.assertEqual(q.getNumOfRecordByConditions("Orders"), 0) #No exsiting group
    ...
    #
    #     numOfRecord = q.getNumOfRecordByConditions("Orders", "order_id = '%s'",
    #     str(orderId))
    ...
    #
    #     numOfRecords = q.getNumOfRecordByConditions("OrderReceipts",
    ...
    #
    #     numOfRecords = q.getNumOfRecordByConditions("Items",
    ...
    #
    #     result_list = q.selectInfoByConditions("Items", "item_name",
    #     "item_id = '%s'", itemId)
    #
    ...
    #
    #     result_list = q.selectInfoByConditions("Items", "left_amount",
    #     "item_id = '%s'", itemId)
    #
    #     self.assertTrue(check)
    #     self.assertEqual(len(result_list), 1)
    ...
    #     self.assertEqual(len(result_list), 1)
    #     self.assertEqual(result_list[0]['left_amount'], itemPrevAmount) #remains
    #
    #     #Too large
    ...
    #     self.assertEqual(q.getNumOfRecordByConditions("Allocations"), 0)        #
    #
    ...
    #     self.assertEqual(len(result_list), 1)
    #     self.assertEqual(result_list[0]['left_amount'],
    #     round(oriAmount - alloAmount, 4))
    #
    #     numOfRecords = q.getNumOfRecordByConditions("Allocations",
    ...
    #
    #     self.assertTrue(check)
    #     self.assertEqual(q.getNumOfRecordByConditions("Allocations",
    #     "allo_id = '%s'", a_id), 0)
    #
    #     self.assertEqual(q.selectInfoByConditions("Items", "left_amount",
    #     "item_id = '%s'", itemId)[0]['left_amount'], oriAmount)
    ...
    #
    #     self.assertTrue(check)
    #     result = q.selectAllByConditions("Allocations", "allo_id = '%s'",
    #     str(a_id))[0]
    #
    #     self.assertEqual(result['allo_amount'], curAlloAmount)
    #     self.assertEqual(q.selectInfoByConditions("Items", "left_amount",
    #     "item_id = '%s'", result['item_id'])[0]['left_amount'],
