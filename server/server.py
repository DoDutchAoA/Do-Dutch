...
preset1 = {
  ...
  "path": "http://52.12.74.177/upload/1image.png"}
...
preset2 = {
  "items": [
    ...
    "accumTotal": 53.96,
    "detectedTotal": 114.58,
    "path": "http://52.12.74.177/upload/image2.jpg"
}
...
preset3= {
  "items": [
    ...
    "accumTotal": 42.35,
    "detectedTotal": 114.58,
    "path": "http://52.12.74.177/upload/image3.jpg"
}

preset4= {
  "items": [
    {"category": "snack", "text": "whipped cream 4.99 f",
        "price": 4.99, "display": "Cream"},
    {"category": "grain", "text": "si chow mein 5pk 4.29",
        "price": 3.99, "display": "Ansungtangmyun"},
    {"category": "grain", "text": "pf sandwish buns 3.49",
        "price": 7.49, "display": "Lactaid 100 whole"},
    {"category": "protein", "text": "dairypure 1% milk 2.99",
    ...
    "accumTotal": 76.24000000000001,
    "detectedTotal": 114.58,
    "path": "http://52.12.74.177/upload/image4.jpg"
}
...
preset5= {
  "items": [
    ...
    "accumTotal": 38.64,
    "detectedTotal": 114.58,
    "path": "http://52.12.74.177/upload/image5.jpg"
}
...
def server():
    if request.method == 'POST' or request.method == 'GET':
        ...
        if file and allowed_file(file.filename):
            ...
            else if file.filename == 'image2.jpg':
                return json.dumps(preset2)
            else if file.filename == 'image3.jpg':
                return json.dumps(preset3)
            else if file.filename == 'image4.jpg':
                return json.dumps(preset4)
            else if file.filename == 'image5.jpg':
                return json.dumps(preset5)
            else
                response = ocr(
                path, os.path.join(
